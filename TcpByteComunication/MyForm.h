...
namespace TcpByteComunication {
	...
	public:
		MyForm(void)
		{
			...
			//unsigned char* buf = (unsigned char*)malloc(400000);
			...
			//System::IO::StreamWriter^ wr = gcnew System::IO::StreamWriter("result.txt");
			//wr->WriteLine(wrStr);
			//wr->Close();
		}
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->ClientSize = System::Drawing::Size(416, 518);
